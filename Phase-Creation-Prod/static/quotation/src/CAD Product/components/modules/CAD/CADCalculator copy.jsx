    ...
    <div>
      ...
      <div
        style={{
          position: "sticky",
          top: 60, // below Tabs
          zIndex: 1000, // VERY IMPORTANT (bring to front)
          backgroundColor: "#ffff", //  use backgroundColor (safer)
          opacity: 1, //
          padding: "20px",

          alignItems: "flex-start",
          gap: "30px",
          borderBottom: "1px solid #ccc", // optional (better separation)
      ...
      >
        ...
        <div style={{ display: "flex", flexDirection: "column" }}>
          ...
          <div>
            ...
            {showCostSheet && (
              /* This wrapper enables scrolling for the Cost Sheet */
              <div
                style={{
                  maxHeight: "600px", // Or "70vh" to scale with screen size
                  overflowY: "auto", // Vertical scroll
                  // overflowX: "auto", // Horizontal scroll for wide sheets
              ...
              >
                <MainCostSheet
                  ...
                  FEASIBILITY={globalParams.Feasibility}
                />
              </div>
            )}
          </div>

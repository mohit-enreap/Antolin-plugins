...
import { calculateCost1 } from "../Data/COST_RATE_BY_ORGUtil";
...
export function fillCostSheetData(
  ...
  const updatedRows5 = template.rows5.map((row) => {
    ...
    if (categoryKey === "Travels") {
      ...
      phase1Cost =
        calculateMaterialCost(phase1Hours, "phase1") + MaterialsPhase1.cost; // Because for phase1 Multiple is Applied

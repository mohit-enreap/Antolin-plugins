  ...
  function handleTemp() {
    ...
    */
    ...
    const tempJSONOutput = {
      Global: globalParams,
      CustomerProductMapping: customerProductConfig,
  ...
  return (
    <div>
      ...
      <div style={styles.page}>
        ...
        <div style={styles.column}>
          <CustomerProductConfig
            customerName={globalParams.Customer}
            productName={globalParams.product}
            onChange={updateCustomerProductConfig}
          />
        </div>
      ...
      >
        ...
        {/* TEMP 3d Aggregated final TABLE */}
        <div style={{ flex: 1, minWidth: 300 }}>
          <h3>Temp 3d Aggregated Results</h3>
        ...
        <div style={{ flex: 1, minWidth: 300 }}>
          <h3>Temp 2d Aggregated Results</h3>
        ...
        {/* TEMP dm TABLE */}
        <div style={{ flex: 1, minWidth: 300 }}>
          <h3>Temp dm Aggregated Results</h3>
        ...
        {/* TEMP gm TABLE */}
        <div style={{ flex: 1, minWidth: 300 }}>
          <h3>Temp gm Aggregated Results</h3>

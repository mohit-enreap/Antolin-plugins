...
const ActivitySubactivityTable = ({ data, onChange }) => {
  ...
  return (
    <div
      style={{
        fontFamily: "inherit", // Respects global font
        fontSize: "14px",
        marginTop: "32px", // Adds breathing room above this section
        marginBottom: "20px",
      }}
    >
      ...
      <div
        style={{
          ...
          fontWeight: "600",
          padding: "12px 16px",
          backgroundColor: "var(--blue, #0b74d1)", // Matches your theme
          color: "#fff",
      ...
      >
        ...
        <div style={{ textAlign: "center" }}>Proto</div>
        ...
        <div key={activity.name}>
          ...
          <div
            style={{
              ...
              gridTemplateColumns: "1fr 120px 120px",
              padding: "12px 16px",
              borderBottom: "1px solid #dcdcdc", // Consistent row divider
              background: "#fff",
              alignItems: "center", // Vertically centers the checkbox and text
            }}
          >
            <div style={{ display: "flex", alignItems: "center", gap: "8px" }}>
              {/* Debug text left exactly as you had it */}
              <span style={{ fontSize: "12px", color: "#999" }}>
                {"===>"} {!!activitySelected[activity.name]?.toString()}
              </span>
              ...
              <strong
                style={{
                  color: "#333",
                  fontWeight: "600",
                  fontSize: "1.05em", // Slightly larger text to match other bold columns
                }}
              >
                {activity.name}
              </strong>
              <span style={{ color: "#666" }}>({activity.hours} hrs)</span>
            </div>
            <div />
            <div />
          </div>
            ...
            return (
              <div
                ...
                style={{
                  display: "grid",
                  gridTemplateColumns: "1fr 120px 120px",
                  // Adjusted padding for indenting
                  padding: isProduct
                    ? "12px 16px 12px 32px"
                    : "12px 16px 12px 52px",
                  borderBottom: "1px solid #eee",
                  opacity: activitySelected[activity.name] ? 1 : 0.4,
                  // Uses a subtle tint of your primary blue for Product rows
                  background: isProduct
                    ? "rgba(11, 116, 209, 0.05)"
                    : "#fafafa",
                  alignItems: "center", // Keeps everything vertically centered
                }}
              >
                <div style={{ display: "flex", alignItems: "center", gap: "6px" }}>
                  <span style={{ color: isProduct ? "var(--blue)" : "#888" }}>
                    {isProduct ? "▸ Product Level:" : "└─ "}
                  </span>
                  <strong style={{ color: "#444", fontWeight: "500" }}>
                    {sub.name}
                  </strong>
                  {!isProduct && (
                    <span style={{ color: "#777", fontSize: "0.95em" }}>
                ...
                <div style={{ display: "flex", justifyContent: "center" }}>
                  <input
                    ...
                    value={values.Proto || ""}
                    style={{
                      maxWidth: "80px", // Constrains the input width
